...
def popupmsg():
    ...
    B1 = Button(popup, text="Okay", bg="red", command=popup.destroy)
    B1.pack()
...
def cal():
    ...
    cal_button_bg = 'lightgreen'
    num_button_bg = 'orange'
    other_button_bg = 'violet'
    text_fg = 'black'
    button_active_bg = 'red'
    ...
    button15 = Button(root, text='back', bg=other_button_bg, padx=10, pady=3,
    ...
    def close():
        exit['command'] = root.close()
    exit = Button(root, text='close', fg='black', bg='lightgrey', command=quit, height=1, width=7)
